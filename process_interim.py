...
RARITY_COLORS = {
    "mundane":   (110, 110, 140),  # slate blue
    "common":    (140, 140, 140),  # grey
    "uncommon":  ( 80, 150,  80),  # muted green
    "rare":      ( 80,  80, 190),  # muted blue
    "very_rare": (140,  80, 190),  # muted purple
    "legendary": (200, 140,  45),  # amber
    "artifact":  (200,  65,  65),  # crimson
}
